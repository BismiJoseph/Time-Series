...
##Visualizations
##Time series plot
plot(candydata,xlab="Year", ylab = "Candy Production as (%) of 2012 Production",main="Monthly US Candy Production ")
...
autoplot(candydata) + labs(x ="Year", y = "Candy Production as (%) of 2012 Production", title="Monthly US Candy Production ") + theme_classic()



##Decompose
#decom<-decompose(candydata)
#plot(decom)

##Finding out whether time series is seasonal or not?
